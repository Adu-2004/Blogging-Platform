...
import "C:/Users/Sakshi/OneDrive/Desktop/YTseries/Blogging Platform/frontend/node_modules/react-chatbotify/dist/style.css";
var Z = {
...
var Y = () => (0, import_react.useContext)(ie);
var At = ({
  children: A,
  styles: e = ce,
  setSyncedStyles: o,
...
var et = ({ buttons: A }) => {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { style: t, className: "rcb-chat-header-container", children: [
    ...
    (0, import_jsx_runtime.jsx)("div", { className: "rcb-chat-header", children: A == null ? void 0 : A.map(
      (f, w) => (0, import_jsx_runtime.jsx)(import_react.Fragment, { children: f }, w)
    ) })
  ] });
};
...
var tt = ({
  ...
  const t = (0, import_react.useRef)(null), n = (0, import_react.useRef)(""), s = (0, import_react.useRef)(null), a = (0, import_react.useRef)(/* @__PURE__ */ new Map()), r = (0, import_react.useRef)(null), c = (0, import_react.useRef)(""), i = (0, import_react.useRef)(false), u = (0, import_react.useRef)(null), f = (0, import_react.useRef)(null), w = (0, import_react.useRef)(null);
...
var eA = () => (0, import_react.useContext)(ue);
var ot = ({
  children: A,
  settings: e
}) => {
  var nA, aA, JA, VA, ZA, _A;
  const [o, t, n] = sA(false), [s, a, r] = sA(
    ((nA = e == null ? void 0 : e.chatWindow) == null ? void 0 : nA.defaultOpen) ?? false
  ), [c, i, u] = sA(
    ((aA = e == null ? void 0 : e.audio) == null ? void 0 : aA.defaultToggledOn) ?? false
  ), [f, w, d] = sA(
    ((JA = e == null ? void 0 : e.voice) == null ? void 0 : JA.defaultToggledOn) ?? false
  ), [
    g,
    B,
    v
  ] = sA(
    ((VA = e == null ? void 0 : e.notification) == null ? void 0 : VA.defaultToggledOn) ?? true
  ), [S, C] = (0, import_react.useState)(false), [h, P] = (0, import_react.useState)(false), [E, y, b] = sA(false), [I, m, p] = sA(true), [
    D,
    Q,
    T
  ] = sA(false), [M, k] = (0, import_react.useState)(false), [U, N] = (0, import_react.useState)(false), [K, J] = (0, import_react.useState)(0), [z, R] = (0, import_react.useState)(0), [W, F] = (0, import_react.useState)(false), [L, G] = (0, import_react.useState)(((ZA = window.visualViewport) == null ? void 0 : ZA.height) ?? window.innerHeight), [tA, _] = (0, import_react.useState)(((_A = window.visualViewport) == null ? void 0 : _A.width) ?? window.innerWidth);
  return (0, import_jsx_runtime.jsx)(ue.Provider, { value: {
    ...
    syncedTextAreaDisabledRef: p,
    textAreaSensitiveMode: D,
    setSyncedTextAreaSensitiveMode: Q,
    syncedTextAreaSensitiveModeRef: T,
    hasInteractedPage: M,
...
var mA = () => (0, import_react.useContext)(fe);
var st = ({ children: A }) => {
  const [e, o, t] = sA([]);
  return (0, import_jsx_runtime.jsx)(fe.Provider, { value: { paths: e, setSyncedPaths: o, syncedPathsRef: t }, children: A });
};
var lA = () => {
  const { botIdRef: A } = $(), { syncedPathsRef: e } = mA(), o = (0, import_react.useCallback)(() => e.current.length > 0 ? e.current.at(-1) ?? null : null, []), t = (0, import_react.useCallback)(() => e.current.length > 1 ? e.current.at(-2) ?? null : null, []);
...
var rA = () => {
  ...
  } = eA(), { chatBodyRef: w } = $(), { dispatchRcbEvent: d } = lA(), g = (0, import_react.useCallback)(() => {
    if (!w.current)
      return false;
    const h = w.current.getBoundingClientRect(), P = window.innerHeight ?? document.documentElement.clientHeight, E = window.innerWidth ?? document.documentElement.clientWidth;
    return h.top >= 0 && h.left >= 0 && h.bottom <= P && h.right <= E;
  }, [w]), B = (0, import_react.useCallback)(async (h) => {
    var P;
    h !== f.current && ((P = A.event) != null && P.rcbToggleChatWindow && (await d(
  ...
  }, [f]), v = (0, import_react.useCallback)(async (h) => {
    h !== u.current && c((P) => !P);
  }, [u]), S = (0, import_react.useCallback)((h, P, E, y) => (h /= y / 2, h < 1 ? E / 2 * h * h + P : (h--, -E / 2 * (h * (h - 2) - 1) + P)), []), C = (0, import_react.useCallback)((h = 0) => {
    if (!w.current)
      return;
    const P = w.current.scrollHeight - w.current.clientHeight;
    if (h <= 0) {
      w.current.scrollTop = P, i(false);
      return;
    }
    const E = w.current.scrollTop, y = P - E, b = 20;
    let I = 0;
    const m = () => {
      if (!w.current)
        return;
      I += b;
      const p = S(I, E, y, h);
      w.current.scrollTop = p, I < h ? requestAnimationFrame(m) : i(false);
    };
    m();
  }, [w]);
  return {
...
var rt = () => {
  var w, d, g;
  const { settings: A } = O(), { styles: e } = Y(), { unreadCount: o, isScrolling: t } = eA(), { chatBodyRef: n } = $(), { scrollToBottom: s } = rA(), [a, r] = (0, import_react.useState)(false), c = {
...
var jA = () => (0, import_react.useContext)(de);
var at = ({ children: A }) => {
  const [e, o, t] = sA([]);
...
var ct = ({
  ...
  var f, w, d, g, B, v;
  const { settings: o } = O(), { styles: t } = Y(), n = typeof A.content == "string", s = A.content, a = A.contentWrapper ? (0, import_jsx_runtime.jsx)(A.contentWrapper, { children: s }) : s, r = {
  ...
  return (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        o.map((w, d) => {
          const g = c(d);
          return w.sender.toUpperCase() === "USER" ? (0, import_jsx_runtime.jsx)(ct, { message: w, isNewSender: g }, d) : w.sender.toUpperCase() === "BOT" ? (0, import_jsx_runtime.jsx)(it, { message: w, isNewSender: g }, d) : (0, import_jsx_runtime.jsx)("div", { children: w.content }, d);
        }),
        n && ((f = A.chatWindow) == null ? void 0 : f.showTypingIndicator) && (0, import_jsx_runtime.jsx)(lt, {}),
...
var ft = ({
  ...
  var v, S, C, h, P, E, y, b, I, m, p;
  const { settings: t } = O(), { styles: n } = Y(), { paths: s } = mA(), { handleSubmitText: a } = yA(), [r, c] = (0, import_react.useState)(/* @__PURE__ */ new Set()), [i, u] = (0, import_react.useState)(false), f = {
    ...
    cursor: i ? `url("${(b = t.general) == null ? void 0 : b.actionDisabledIcon}"), auto` : "pointer",
    color: "#fff",
  ...
  return (0, import_jsx_runtime.jsxs)("div", { className: `rcb-checkbox-container ${(p = t.botBubble) != null && p.showAvatar ? "rcb-checkbox-offset" : ""}`, children: [
    A.items.map((D) => (0, import_jsx_runtime.jsx)(
      "div",
      {
        onMouseDown: (Q) => {
          Q.preventDefault(), B(D);
        },
        style: f,
        ...
        children: (0, import_jsx_runtime.jsxs)("div", { className: "rcb-checkbox-row", children: [
          ...
          (0, import_jsx_runtime.jsx)("div", { className: "rcb-checkbox-label", children: D })
        ] })
      },
      D
    )),
    (0, import_jsx_runtime.jsx)(
      "div",
      {
        ...
        onMouseDown: (D) => {
          var M;
          if (D.preventDefault(), i || r.size < A.min)
            return;
          const Q = Array.from(e).join(", ");
          u(!A.reusable);
          let T;
          A.sendOutput != null ? T = A.sendOutput : T = ((M = t.chatInput) == null ? void 0 : M.sendCheckboxOutput) ?? true, a(Q, T);
        }
      }
    )
  ] });
...
var Bt = ({
  ...
  var g, B, v, S, C, h;
  const { settings: o } = O(), { styles: t } = Y(), { paths: n } = mA(), { handleSubmitText: s } = yA(), [a, r] = (0, import_react.useState)([]), [c, i] = (0, import_react.useState)(false), u = {
  ...
  return (0, import_jsx_runtime.jsx)("div", { className: `rcb-options-container ${(h = o.botBubble) != null && h.showAvatar ? "rcb-options-offset" : ""}`, children: A.items.map((P, E) => {
    const y = a[E] && !c;
    return (0, import_jsx_runtime.jsx)(
      "div",
      {
        ...
        onMouseDown: (b) => {
          ...
          i(!A.reusable);
          let I;
          A.sendOutput != null ? I = A.sendOutput : I = ((m = o.chatInput) == null ? void 0 : m.sendOptionOutput) ?? true, s(P, I);
        },
        children: P
      },
      P
...
var It = (A, e, o, t, n, s, a, r, c) => {
  ...
  if (Be = true, o != null)
    try {
      const u = gA((0, import_jsx_runtime.jsx)(mt, {}), "SYSTEM"), f = n.current.slice(1);
      t([u, ...f]);
      const w = o.map((d) => {
        if (d.type === "object") {
      ...
      return r.textContent;
    {
      ...
      let f = Array.from(r.attributes).reduce((d, g) => {
        ...
        if (B === "style") {
          ...
          v.forEach((C) => {
            const [h, P] = C.split(":").map((y) => y.trim()), E = h.replace(/-([a-z])/g, (y, b) => b.toUpperCase());
            S[E] = P;
          }), d[B] = S;
      ...
      if ([
        ...
        return (0, import_react.createElement)(u, { key: c, ...f });
      {
        const d = Pe(r.innerHTML, e, o);
        return (0, import_react.createElement)(u, { key: c, ...f }, ...d);
      }
    }
  });
};
...
var GA = () => {
  const { settings: A } = O(), {
  ...
  } = eA(), { audioBufferRef: r, audioContextRef: c, gainNodeRef: i } = $(), { dispatchRcbEvent: u } = lA(), f = (0, import_react.useCallback)(async () => {
    var S, C;
    ...
    if (g != null && g.startsWith("data:audio")) {
      const h = atob(g.split(",")[1]), P = new ArrayBuffer(h.length), E = new Uint8Array(P);
    ...
    r,
    i
  ]), d = (0, import_react.useCallback)(async (g) => {
    var B;
...
var YA = () => {
  const { settings: A } = O(), { audioToggledOn: e, setSyncedAudioToggledOn: o, syncedAudioToggledOnRef: t } = eA(), { dispatchRcbEvent: n } = lA(), s = (0, import_react.useCallback)(async (r) => {
    var c;
...
var PA = () => {
  ...
  const { settings: A } = O(), { messages: e, setSyncedMessages: o, syncedMessagesRef: t } = jA(), {
    ...
    syncedIsChatWindowOpenRef: r
  } = eA(), { streamMessageMap: c, chatBodyRef: i, paramsInputRef: u } = $(), { scrollToBottom: f, getIsChatBotVisible: w } = rA(), { dispatchRcbEvent: d } = lA(), { speakAudio: g } = YA(), { playNotificationSound: B } = GA(), v = (0, import_react.useCallback)((m, p = false) => {
    var M, k;
    HA(m);
    let D = true;
    ...
    if (!Q)
      return;
    const T = Q.sender.toUpperCase();
    T === "USER" && (D = false), (M = A.general) != null && M.embedded && w() && (D = false), (r.current && !a.current || p) && (D = false), D && B(), !p && (T !== "USER" && ((k = A.chatWindow) != null && k.autoJumpToBottom) || T === "USER" || !a.current) && setTimeout(() => f(), 1);
  }, [
    A,
    i,
    r,
    ...
    f,
    w
  ]), S = (0, import_react.useCallback)(async (m, p = "BOT", D = null) => {
    var J, z, R, W, F;
    if (typeof m != "string")
    ...
    if ((J = A.event) != null && J.rcbStartSimulateStreamMessage) {
      ...
      if (L.defaultPrevented)
        return null;
      D = L.data.simulateStreamChunker || D, Q = L.data.message;
    }
    n(false);
    let T = 30;
    p === "BOT" ? T = (z = A.botBubble) == null ? void 0 : z.streamSpeed : T = (R = A.userBubble) == null ? void 0 : R.streamSpeed;
    const M = { ...Q, content: "" };
    o((L) => [...L, M]), v(t.current);
    let k = Q.content;
    D && (k = D(k));
    ...
    return (a.current || !r.current) && s((L) => L + 1), await K, HA(t.current), (F = A.event) != null && F.rcbStopSimulateStreamMessage && await d(H.STOP_SIMULATE_STREAM_MESSAGE, { message: Q }), p === "USER" && (u.current = m), Q;
  }, [
    A,
    d,
    v,
    ...
    r,
    g
  ]), C = (0, import_react.useCallback)(async (m, p = "BOT") => {
    var Q, T, M;
    p = p.toUpperCase();
    let D = gA(m, p);
    if ((Q = A.event) != null && Q.rcbPreInjectMessage) {
      const k = await d(H.PRE_INJECT_MESSAGE, { message: D });
      if (k.defaultPrevented)
        return null;
      D = k.data.message;
    }
    return D.sender.toUpperCase() === "BOT" && (r.current || (T = A.general) != null && T.embedded) && typeof D.content == "string" && D.content.trim() !== "" && g(D.content), (a.current || !r.current) && s((k) => k + 1), (M = A.event) != null && M.rcbPostInjectMessage && await d(H.POST_INJECT_MESSAGE, { message: D }), o((k) => [...k, D]), v(t.current), p === "USER" && typeof m == "string" && (u.current = m), D;
  }, [
    A,
    d,
    v,
    ...
    g,
    s
  ]), h = (0, import_react.useCallback)(async (m) => {
    var D;
    const p = t.current.find((Q) => Q.id === m);
    return !p || (D = A.event) != null && D.rcbRemoveMessage && (await d(H.REMOVE_MESSAGE, { message: p })).defaultPrevented ? null : (o(
      (Q) => Q.filter((T) => T.id !== m)
    ), v(t.current), s((Q) => Math.max(Q - 1, 0)), p);
  }, [
    d,
    (b = A.event) == null ? void 0 : b.rcbRemoveMessage,
    v,
    t,
    s
  ]), P = (0, import_react.useCallback)(async (m, p = "BOT") => {
    var Q, T;
    if (p = p.toUpperCase(), !c.current.has(p)) {
      const M = gA(m, p);
      return (Q = A.event) != null && Q.rcbStartStreamMessage && (await d(H.START_STREAM_MESSAGE, { message: M })).defaultPrevented ? null : (n(false), o((k) => [...k, M]), v(t.current), c.current.set(p, M.id), (a.current || !r.current) && s((k) => k + 1), M);
    }
    const D = { ...gA(m, p), id: c.current.get(p) };
    return (T = A.event) != null && T.rcbChunkStreamMessage && (await d(H.CHUNK_STREAM_MESSAGE, { message: D })).defaultPrevented ? null : (o(
      (M) => M.map((k) => k.id === D.id ? D : k)
    ), v(t.current, true), D);
  }, [
    d,
    A.event,
    ...
    s,
    c
  ]), E = (0, import_react.useCallback)(async (m = "BOT") => {
    var Q;
    if (m = m.toUpperCase(), !c.current.has(m))
      return true;
    const p = c.current.get(m);
    let D;
    for (let T = 0; T < 3; T++) {
      const M = t.current.find((k) => k.id === p);
      M && (D = M), await new Promise((k) => setTimeout(k, 20));
    }
    return (Q = A.event) != null && Q.rcbStopStreamMessage && (await d(H.STOP_STREAM_MESSAGE, { message: D })).defaultPrevented ? false : (c.current.delete(m), HA(t.current), m === "USER" && typeof (D == null ? void 0 : D.content) == "string" && (u.current = D.content), true);
  }, [d, (I = A.event) == null ? void 0 : I.rcbStopStreamMessage, c, u]), y = (0, import_react.useCallback)((m) => {
    const p = typeof m == "function" ? m(t.current) : m;
    o(p), v(p);
  }, [v, t]);
  return {
...
var WA = () => {
  const A = XA();
  A && (BA = false, A && A.stop(), cA && cA.state !== "inactive" && (cA.stop(), cA = null), clearTimeout(uA), uA = null, clearTimeout(pA));
};
var Ut = (A, e) => {
  var t, n, s;
  const o = XA();
  (t = e.voice) != null && t.disabled || !((n = e.chatInput) != null && n.blockSpam) || !o || (A && !BA ? (BA = true, (s = e.voice) != null && s.sendAsAudio ? cA == null || cA.start() : o.start()) : A || WA());
};
var OA = async (A, e) => {
  var o;
...
var TA = () => {
  const { settings: A } = O(), { voiceToggledOn: e, setSyncedVoiceToggledOn: o, syncedVoiceToggledOnRef: t } = eA(), { dispatchRcbEvent: n } = lA(), s = (0, import_react.useCallback)(async (r) => {
    var c;
...
var DA = () => {
  ...
  const { settings: A } = O(), {
  ...
  } = eA(), { inputRef: i, chatBodyRef: u, prevInputRef: f } = $(), { dispatchRcbEvent: w } = lA(), { getIsChatBotVisible: d } = rA(), g = (0, import_react.useCallback)(async (y) => {
    var b, I, m;
    ...
    if (i.current && f.current !== null) {
      const p = (b = A.chatInput) == null ? void 0 : b.characterLimit, Q = ((I = A.chatInput) == null ? void 0 : I.allowNewline) ? y : y.replace(/\n/g, " ");
      if (p != null && p >= 0 && Q.length > p ? i.current.value = Q.slice(0, p) : i.current.value = Q, (m = A.event) != null && m.rcbTextAreaChangeValue && (await w(
  ...
  }, [r, i, f, A, w]), B = (0, import_react.useCallback)((y) => {
    var b;
    (b = i.current) != null && b.disabled || setTimeout(() => {
      var I, m, p;
      (I = A.general) != null && I.embedded ? d() && ((m = i.current) == null || m.focus()) : y !== "start" && ((p = i.current) == null || p.focus());
    }, 100);
  }, [i, (E = A.general) == null ? void 0 : E.embedded, u, d]), v = (0, import_react.useCallback)(() => {
    i.current && i.current.focus();
  }, []), S = (0, import_react.useCallback)(() => {
    i.current && i.current.blur();
  }, []), C = (0, import_react.useCallback)(() => i && i.current ? i.current.value : "", []), h = (0, import_react.useCallback)((y) => {
    y !== r.current && n((b) => !b);
  }, [r]), P = (0, import_react.useCallback)((y) => {
    y !== c.current && a((b) => !b);
  }, [c]);
  return {
    textAreaDisabled: t,
...
var EA = () => {
  const { settings: A } = O(), { toasts: e, setSyncedToasts: o, syncedToastsRef: t } = Ee(), { dispatchRcbEvent: n } = lA(), s = (0, import_react.useCallback)(async (c, i) => {
    var g, B, v, S;
    let u = null;
...
var QA = () => {
  ...
  const { settings: A } = O(), { paths: e, setSyncedPaths: o, syncedPathsRef: t } = mA(), { flowRef: n, streamMessageMap: s, paramsInputRef: a, keepVoiceOnRef: r, timeoutIdRef: c } = $(), {
    ...
    streamMessage: h
  } = PA(), { showToast: P, dismissToast: E } = EA(), { toggleChatWindow: y } = rA(), { updateTextAreaFocus: b, setTextAreaValue: I } = DA(), { syncVoice: m } = TA(), p = (0, import_react.useCallback)(async (R) => {
    var W;
    ...
    return R;
  }, [(U = A.event) == null ? void 0 : U.rcbPostProcessBlock, g]), D = (0, import_react.useCallback)(async (R, W) => {
    var G, tA, _, nA;
    if (!R)
      return;
    let F = n.current[R];
    ...
    i(true), (tA = A.chatInput) != null && tA.blockSpam && u(true), f(false);
    const L = {
      prevPath: W,
      currPath: R,
      goToPath: M,
    ...
    await yt(
      F,
      L,
      ((_ = A.botBubble) == null ? void 0 : _.simulateStream) ?? false,
      c,
      u,
      f,
      p
    ), i(false), "chatDisabled" in F || u((nA = A.chatInput) == null ? void 0 : nA.disabled), "isSensitive" in F || f(false), d(typeof F.file == "function"), b(R), m(r.current && !F.chatDisabled), R !== W && s.current.clear();
  }, [
    n,
    b,
    m,
    ...
    r,
    s
  ]), Q = (0, import_react.useCallback)(() => t.current.length > 0 ? t.current.at(-1) ?? null : null, []), T = (0, import_react.useCallback)(() => t.current.length > 1 ? t.current.at(-2) ?? null : null, []), M = (0, import_react.useCallback)(async (R) => {
    var L;
    const W = Q(), F = T();
    return (L = A.event) != null && L.rcbChangePath && (await g(H.CHANGE_PATH, {
      ...
      prevPath: F,
      nextPath: R
    })).defaultPrevented ? false : (o((G) => [...G, R]), await D(R, W), true);
  }, [(J = A.chatInput) == null ? void 0 : J.blockSpam, (z = A.event) == null ? void 0 : z.rcbChangePath, D, g]), k = (0, import_react.useCallback)((R) => {
...
var yA = () => {
  ...
  } = eA(), { flowRef: C, inputRef: h, keepVoiceOnRef: P, paramsInputRef: E, timeoutIdRef: y } = $(), { showToast: b, dismissToast: I } = EA(), { dispatchRcbEvent: m } = lA(), { syncVoice: p } = TA(), { setTextAreaValue: D } = DA(), { toggleChatWindow: Q } = rA(), T = (0, import_react.useCallback)(async (z) => {
    var F, L, G, tA, _, nA;
    const R = r();
    if (!(!R || !C.current[R])) {
      if (S.current) {
  ...
  }, [C, r, A, o, n, S]), M = (0, import_react.useCallback)(async (z, R = true) => {
    var G, tA;
    if (z = z.trim(), z === "")
      return;
    R && await T(z), y.current && clearTimeout(y.current), h.current && (D(""), B(0));
    const W = r();
    if (!W)
      return;
    let F = C.current[W];
    const L = await u(F);
    L && ((G = A.chatInput) != null && G.blockSpam && w(true), P.current = v.current, p(false), setTimeout(() => {
      d(true);
    }, 400), f(false), setTimeout(async () => {
      var aA;
      const _ = {
        prevPath: c(),
        currPath: r(),
      ...
      await ge(L, _), a.current.length === nA && ("chatDisabled" in F ? w(!!F.chatDisabled) : w(!!((aA = A.chatInput) != null && aA.disabled)), we(F, _, f), g(typeof F.file == "function"), p(P.current), d(false));
  ...
  return { handleSubmitText: (0, import_react.useCallback)(async (z, R = true) => {
    var F, L;
...
var zt = ({ buttons: A }) => {
  ...
  const e = MA(), { settings: o } = O(), { styles: t } = Y(), {
    ...
    setHasFlowStarted: c,
    setInputLength: i
  } = eA(), { inputRef: u } = $(), [f, w] = (0, import_react.useState)(false), [d, g] = (0, import_react.useState)(false), { handleSubmitText: B } = yA(), { setTextAreaValue: v } = DA(), S = {
    boxSizing: e ? "content-box" : "border-box",
    ...t.chatInputAreaStyle
  }, C = {
    outline: n ? "" : "none",
    boxShadow: n ? "" : `0 0 5px ${(T = o.general) == null ? void 0 : T.primaryColor}`,
    boxSizing: e ? "content-box" : "border-box",
    ...t.chatInputAreaStyle,
  ...
  }, y = n ? (k = o.chatInput) == null ? void 0 : k.disabledPlaceholderText : (U = o.chatInput) == null ? void 0 : U.enabledPlaceholderText, b = () => {
    n || w(true);
  }, I = () => {
    w(false);
  }, m = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      onMouseDown: (L) => {
        var G;
        L.stopPropagation(), !r && ((G = o.general) == null ? void 0 : G.flowStartTrigger) === "ON_CHATBOT_INTERACT" && c(true);
      },
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          A == null ? void 0 : A.map(
            (L, G) => (0, import_jsx_runtime.jsx)(import_react.Fragment, { children: L }, G)
          ),
          ((J = o.chatInput) == null ? void 0 : J.showCharacterCount) && ((z = o.chatInput) == null ? void 0 : z.characterLimit) != null && ((R = o.chatInput) == null ? void 0 : R.characterLimit) > 0 && (0, import_jsx_runtime.jsxs)(
            "div",
            {
              className: "rcb-chat-input-char-counter",
              style: a >= ((W = o.chatInput) == null ? void 0 : W.characterLimit) ? E : P,
              children: [
                a,
                "/",
...
var Yt = () => {
  var d, g, B, v, S, C, h;
  const { settings: A } = O(), { styles: e } = Y(), { unreadCount: o } = eA(), { isChatWindowOpen: t, toggleChatWindow: n } = rA(), [s, a] = (0, import_react.useState)(false), r = {
    ...
    var E;
    const P = (E = A.chatButton) == null ? void 0 : E.icon;
    ...
    ) : P && (0, import_jsx_runtime.jsx)("span", { className: "rcb-toggle-icon", children: (0, import_jsx_runtime.jsx)(P, { style: i }) });
  };
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: !((v = A.general) != null && v.embedded) && (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        w(),
        !((C = A.notification) != null && C.disabled) && ((h = A.notification) == null ? void 0 : h.showCount) && (0, import_jsx_runtime.jsx)("span", { style: { ...e.notificationBadgeStyle }, className: "rcb-badge", children: o })
      ]
    }
  ) });
};
var Xt = () => {
  var g, B, v, S, C, h;
  const A = MA(), { settings: e } = O(), { styles: o } = Y(), { chatBodyRef: t } = $(), { isChatWindowOpen: n, toggleChatWindow: s } = rA(), [a, r] = (0, import_react.useState)(false), [c, i] = (0, import_react.useState)(false), [u, f] = (0, import_react.useState)(0);
  (0, import_react.useEffect)(() => {
    var E, y, b;
    const P = (E = e.tooltip) == null ? void 0 : E.mode;
    if (P === "ALWAYS")
      if (A) {
        let I;
        n ? I = (((y = t.current) == null ? void 0 : y.offsetWidth) ?? 375) - (typeof ((b = o.chatButtonStyle) == null ? void 0 : b.width) == "number" ? o.chatButtonStyle.width : 75) : I = 0, f(I), r(true);
      } else
        r(!n);
    else P === "NEVER" ? r(false) : P === "START" ? c ? r(false) : (i(true), r(true)) : P === "CLOSE" && r(!n);
  }, [
    n,
    A,
    c,
  ...
  const w = {
    ...
    right: (((v = o.chatButtonStyle) == null ? void 0 : v.width) ?? 75) + 40,
    bottom: 30,
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: !((C = e.general) != null && C.embedded) && (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      onClick: () => s(true),
      children: [
        (0, import_jsx_runtime.jsx)("span", { children: (h = e.tooltip) == null ? void 0 : h.text }),
        (0, import_jsx_runtime.jsx)("span", { className: "rcb-chat-tooltip-tail", style: d })
      ]
    }
  ) });
};
var Wt = ({
  ...
  var w, d;
  const { settings: t } = O(), { styles: n } = Y(), [s] = (0, import_react.useState)({
    toastPromptStyle: { ...n.toastPromptStyle },
    toastPromptHoveredStyle: { ...n.toastPromptHoveredStyle }
  }), { dismissToast: a } = EA(), [r, c] = (0, import_react.useState)(false), i = {
...
var qt = () => {
  ...
  const { settings: A } = O(), { styles: e } = Y(), {
    ...
    removeMessage: s,
    endStreamMessage: a
  } = PA(), { getCurrPath: r, getPrevPath: c, goToPath: i, blockAllowsAttachment: u } = QA(), { flowRef: f, inputRef: w } = $(), d = f.current, { showToast: g, dismissToast: B } = EA(), { dispatchRcbEvent: v } = lA(), { toggleChatWindow: S } = rA(), { setTextAreaValue: C } = DA(), { handleSubmitText: h } = yA(), P = {
    ...
    backgroundImage: `url(${(D = A.fileAttachment) == null ? void 0 : D.icon})`,
    fill: "#a6a6a6",
    ...e.fileAttachmentIconStyle,
    // by default inherit the base style
    ...
    if (z != null) {
      ...
      for (let tA = 0; tA < N.length; tA++) {
        ...
        !_.fileType || !_.fileUrl || await o((0, import_jsx_runtime.jsx)(
          ye,
          {
            file: N[tA],
            fileType: _.fileType,
    ...
    return !k || typeof k == "string" ? (0, import_jsx_runtime.jsx)(
      "span",
      {
        className: u ? "rcb-attach-icon-enabled" : "rcb-attach-icon-disabled",
        style: u ? E : y
      }
    ) : k && (0, import_jsx_runtime.jsx)("span", { className: u ? "rcb-attach-icon-enabled" : "rcb-attach-icon-disabled", children: (0, import_jsx_runtime.jsx)(
      k,
      {
        style: u ? E : y
      }
  ...
  return (0, import_jsx_runtime.jsxs)(
    "label",
    {
      ...
      style: u ? { ...e.fileAttachmentButtonStyle } : P,
      children: [
        (0, import_jsx_runtime.jsx)(
          "input",
          {
            ...
            type: "file",
            onChange: b,
            multiple: (T = A.fileAttachment) == null ? void 0 : T.multiple,
...
var Jt = () => {
  var v, S, C, h, P, E;
  const { settings: A } = O(), { styles: e } = Y(), { syncedTextAreaDisabledRef: o } = eA(), { inputRef: t } = $(), { textAreaDisabled: n, setTextAreaValue: s } = DA(), a = (0, import_react.useRef)(null), r = (0, import_react.useRef)(null), [c, i] = (0, import_react.useState)(false), u = {
  ...
  (0, import_react.useEffect)(() => {
    const y = (m) => {
      const p = m.composedPath();
      a.current && !p.includes(a.current) && r.current && !p.includes(r.current) && i(false);
    }, b = () => {
      if (a.current && r.current) {
        const m = r.current.getBoundingClientRect(), p = a.current.offsetHeight, D = m.top - p - 8;
        a.current.style.left = `${m.left}px`, a.current.style.top = `${D}px`;
      }
    }, I = () => {
      b();
    };
  ...
  const d = (y, b) => {
    y.preventDefault(), t.current && (s(t.current.value + b), setTimeout(() => {
      ...
      if (I) {
        I.focus();
        const m = I.value.length;
        I.setSelectionRange(m, m);
      }
    }, 50)), i(false);
  }, g = (y) => {
    y.preventDefault(), o.current ? i(false) : i((b) => !b);
  }, B = () => {
    var b, I;
    const y = n ? (b = A.emoji) == null ? void 0 : b.iconDisabled : (I = A.emoji) == null ? void 0 : I.icon;
    return !y || typeof y == "string" ? (0, import_jsx_runtime.jsx)(
      "span",
      {
        className: `${n ? "rcb-emoji-icon-disabled" : "rcb-emoji-icon-enabled"}`,
        style: n ? w : f
      }
    ) : y && (0, import_jsx_runtime.jsx)("span", { className: `${n ? "rcb-emoji-icon-disabled" : "rcb-emoji-icon-enabled"}`, children: (0, import_jsx_runtime.jsx)(y, { style: n ? w : f }) });
  };
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    c && (0, import_jsx_runtime.jsx)("div", { className: "rcb-emoji-button-popup", ref: a, children: (E = (P = A.emoji) == null ? void 0 : P.list) == null ? void 0 : E.map((y, b) => (0, import_jsx_runtime.jsx)(
      "span",
      {
        className: "rcb-emoji",
        onMouseDown: (I) => d(I, y),
...
var Ao = () => {
  var C, h, P;
  const { settings: A } = O(), { styles: e } = Y(), { injectMessage: o } = PA(), { inputRef: t } = $(), { voiceToggledOn: n, toggleVoice: s } = TA(), { setInputLength: a, setTextAreaValue: r, textAreaDisabled: c } = DA(), { handleSubmitText: i } = yA(), u = (0, import_react.useRef)([]), [f, w] = (0, import_react.useState)(false);
  (0, import_react.useEffect)(() => {
    var E;
  ...
  const d = {
    ...
    const E = new Blob(u.current, { type: "audio/wav" }), y = new File([E], "voice-input.wav", { type: "audio/wav" }), b = await Ce(y);
    !b.fileType || !b.fileUrl || await o((0, import_jsx_runtime.jsx)(
      ye,
      {
        file: y,
        fileType: b.fileType,
    ...
    var y, b;
    const E = n ? (y = A.voice) == null ? void 0 : y.icon : (b = A.voice) == null ? void 0 : b.iconDisabled;
    return !E || typeof E == "string" ? (0, import_jsx_runtime.jsx)(
      "span",
      {
    ...
    ) : E && (0, import_jsx_runtime.jsx)("span", { className: `rcb-voice-icon ${n && !c ? "on" : ""}`, children: (0, import_jsx_runtime.jsx)(E, { style: n && !c ? d : g }) });
  };
  return (0, import_jsx_runtime.jsx)(
    "div",
    {
...
var eo = () => {
  var B, v, S, C, h, P, E, y;
  const { settings: A } = O(), { styles: e } = Y(), { textAreaDisabled: o } = eA(), [t, n] = (0, import_react.useState)(false), { handleSubmitText: s } = yA(), a = {
...
var to = (A) => Object.values(Z).includes(A);
var oo = (A, e) => {
...
var no = () => (0, import_jsx_runtime.jsx)(Vt, {});
...
var io = () => (0, import_jsx_runtime.jsx)(qt, {});
var lo = () => (0, import_jsx_runtime.jsx)(Jt, {});
var uo = () => {
  const { settings: A } = O(), e = (0, import_react.useMemo)(() => ({
...
var KA = () => {
  ...
  } = eA(), { chatBodyRef: c } = $(), { dispatchRcbEvent: i } = lA(), u = (0, import_react.useCallback)(async () => {
    var d, g;
    const f = zA();
...
var fo = () => {
  var c, i, u;
  const { settings: A } = O(), { styles: e } = Y(), { showChatHistory: o } = KA(), [t, n] = (0, import_react.useState)(false), s = {
...
var me = () => {
  var a;
  const { settings: A } = O(), { hasInteractedPage: e, setHasInteractedPage: o, hasFlowStarted: t, setHasFlowStarted: n } = eA(), s = (0, import_react.useCallback)(() => {
    var c;
...
var wo = () => {
  ...
  } = eA(), { chatBodyRef: d } = $(), { viewportHeight: g, setViewportHeight: B, setViewportWidth: v, scrollToBottom: S } = rA(), { setUpNotifications: C } = GA(), { handleFirstInteraction: h } = me(), { showChatHistory: P } = KA(), E = (0, import_react.useRef)(0), y = (0, import_react.useRef)(false);
  (0, import_react.useEffect)(() => (window.addEventListener("click", h), window.addEventListener("keydown", h), window.addEventListener("touchstart", h), () => {
    ...
    if (!D)
      return;
    const Q = () => {
      y.current || (y.current = true, requestAnimationFrame(() => {
        var N, K;
        if (!D)
          return;
        const { scrollTop: T, clientHeight: M, scrollHeight: k } = D, U = T + M < k - (((N = e.chatWindow) == null ? void 0 : N.messagePromptOffset) ?? 30);
        u(U), f.current = U, U || (T + M >= k - 1 && (D.scrollTop = k - M - 1), (w.current || (K = e.general) != null && K.embedded) && s(0)), y.current = false;
      }));
    };
    return D.addEventListener("wheel", Q, { passive: true }), D.addEventListener("touchmove", Q, { passive: true }), () => {
      D.removeEventListener("wheel", Q), D.removeEventListener("touchmove", Q);
    };
  }, []), (0, import_react.useEffect)(() => {
    var D, Q, T;
    r((D = e.chatInput) == null ? void 0 : D.disabled), a((Q = e.chatWindow) == null ? void 0 : Q.defaultOpen), c((T = e.audio) == null ? void 0 : T.defaultToggledOn), setTimeout(() => {
      var M;
      i((M = e.voice) == null ? void 0 : M.defaultToggledOn);
    }, 1);
  }, []), (0, import_react.useEffect)(() => {
    var D;
    (D = e.notification) != null && D.disabled || C();
  }, [(b = e.notification) == null ? void 0 : b.disabled]), (0, import_react.useEffect)(() => {
    !f.current && (d != null && d.current) && S();
  }, [t]), (0, import_react.useEffect)(() => {
    var D, Q;
    if ((D = e.chatHistory) != null && D.disabled)
      pt();
    else if (RA(e), zA().length > 0) {
      const M = gA((0, import_jsx_runtime.jsx)(fo, {}), "SYSTEM");
      o([M]), (Q = e.chatHistory) != null && Q.autoLoad && P();
    }
  }, [(I = e.chatHistory) == null ? void 0 : I.storageKey, (m = e.chatHistory) == null ? void 0 : m.maxEntries, (p = e.chatHistory) == null ? void 0 : p.disabled]), (0, import_react.useEffect)(() => {
    var D;
    A || (D = e.general) != null && D.embedded || !navigator.virtualKeyboard || (navigator.virtualKeyboard.overlaysContent = true, navigator.virtualKeyboard.addEventListener("geometrychange", (Q) => {
      if (!Q.target)
        return;
      const { x: T, y: M, width: k, height: U } = Q.target.boundingRect;
      T == 0 && M == 0 && k == 0 && U == 0 ? (setTimeout(() => {
        var N;
    ...
    const D = () => window.scrollTo({ top: 0, left: 0, behavior: "auto" }), Q = () => E.current = window.scrollY, T = () => {
      var J, z;
      B((J = window.visualViewport) == null ? void 0 : J.height), v((z = window.visualViewport) == null ? void 0 : z.width);
    }, M = () => {
      var J;
      window.removeEventListener("scroll", D), window.removeEventListener("scroll", Q), (J = window.visualViewport) == null || J.removeEventListener("resize", T);
    };
    return n ? (M(), document.body.style.position = "fixed", window.addEventListener("scroll", D), (N = window.visualViewport) == null || N.addEventListener("resize", T)) : (document.body.style.position = "static", M(), window.scrollTo({ top: E.current, left: 0, behavior: "auto" }), window.addEventListener("scroll", Q), (K = window.visualViewport) == null || K.removeEventListener("resize", T)), M;
  }, [n, A]);
};
var qA = {
...
var go = qA.DEFAULT_URL;
var Bo = qA.DEFAULT_EXPIRATION;
var Qe = qA.CACHE_KEY_PREFIX;
var vo = (A, e, o) => {
...
var be = () => {
  const { settings: A, setSyncedSettings: e, syncedSettingsRef: o } = O(), t = (0, import_react.useCallback)((s) => {
...
var pe = () => {
  const { styles: A, setSyncedStyles: e, syncedStylesRef: o } = Y(), t = (0, import_react.useCallback)((s) => {
    !s || Object.keys(s).length === 0 || e(kA(fA(s, A)));
  }, [A]), n = (0, import_react.useCallback)((s) => {
    const a = typeof s == "function" ? s(o.current) : s;
    e(a);
...
var mo = ({
  ...
  const B = (0, import_react.useMemo)(() => {
    ...
    return (E = t.general) != null && E.embedded ? P + "rcb-window-embedded" : u ? P + "rcb-window-open" : P + "rcb-window-close";
  }, [t, u]), v = () => {
    var P, E;
    return !o && !((P = t.general) != null && P.embedded) ? {
      ...n.chatWindowStyle,
      borderRadius: "0px",
      left: "0px",
      right: "auto",
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (() => {
    var P, E;
    return o && ((P = t.device) == null ? void 0 : P.desktopEnabled) || !o && ((E = t.device) == null ? void 0 : E.mobileEnabled);
  })() && (0, import_jsx_runtime.jsxs)(
    "div",
    {
      onMouseDown: (P) => {
        var E, y;
        !s && ((E = t.general) == null ? void 0 : E.flowStartTrigger) === "ON_CHATBOT_INTERACT" && a(true), o ? (y = r.current) == null || y.blur() : P == null || P.preventDefault();
      },
      className: B,
      children: [
        (0, import_jsx_runtime.jsx)(Xt, {}),
        (0, import_jsx_runtime.jsx)(Yt, {}),
        u && !o && !((h = t.general) != null && h.embedded) && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        ...
        (0, import_jsx_runtime.jsx)("div", { style: v(), className: "rcb-chat-window", children: (() => {
          var I, m, p;
          const P = (e == null ? void 0 : e.chatBotHeader) || et, E = (e == null ? void 0 : e.chatBotBody) || ut, y = (e == null ? void 0 : e.chatBotInput) || zt, b = (e == null ? void 0 : e.chatBotFooter) || Gt;
          return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            ((I = t.general) == null ? void 0 : I.showHeader) && (0, import_jsx_runtime.jsx)(P, { buttons: w }),
            (0, import_jsx_runtime.jsx)(E, {}),
            (0, import_jsx_runtime.jsx)(Kt, {}),
            ((m = t.general) == null ? void 0 : m.showInputRow) && (0, import_jsx_runtime.jsx)(y, { buttons: d }),
            ((p = t.general) == null ? void 0 : p.showFooter) && (0, import_jsx_runtime.jsx)(b, { buttons: g })
          ] });
        })() })
      ]
    }
...
var Qo = ({
  ...
  var w;
  const e = (0, import_react.useRef)(""), o = (0, import_react.useRef)({}), [t, n, s] = sA({}), [a, r, c] = sA({}), [i, u] = (0, import_react.useState)(false);
  (0, import_react.useEffect)(() => {
    u(true);
  }, []);
  ...
  return i ? (0, import_jsx_runtime.jsx)("div", { style: { fontFamily: (w = t.general) == null ? void 0 : w.fontFamily }, children: (0, import_jsx_runtime.jsx)(Se.Provider, { value: { loadConfig: f }, children: (0, import_jsx_runtime.jsx)(
    $e,
    {
      settings: t,
      setSyncedSettings: n,
...
var bo = ({
  ...
  const f = async () => {
    ...
    )).defaultPrevented || (i != null && i.loadConfig && (await i.loadConfig(c, e, o, t, n, r), a(true)), (d = o.event) != null && d.rcbPostLoadChatBot && NA(
      H.POST_LOAD_CHATBOT,
      { botId: c, currPath: null, prevPath: null },
      {
        flow: e,
...
var LA = ["Quickstart", "API Docs", "Examples", "Github", "Discord"];
var po = {
  start: {
...
var Oo = ({
  ...
  const r = (0, import_react.useMemo)(() => A || "rcb-" + SA(), []), c = !e || Object.keys(e).length === 0 ? po : e, i = o || {}, u = t || {}, f = s || [], [w, d] = (0, import_react.useState)(false), g = Ie(), B = (0, import_react.useRef)(null), [v, S] = (0, import_react.useState)(n || []);
  (0, import_react.useEffect)(() => {
    n && S(n);
  }, [n]);
  const C = () => (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)(
      bo,
      {
        styleRootRef: B,
  ...
  return g == null ? (0, import_jsx_runtime.jsxs)(Qo, { children: [
    ...
    (0, import_jsx_runtime.jsx)("div", { id: r, children: C() })
  ] }) : (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)("style", { ref: B }),
    (0, import_jsx_runtime.jsx)("div", { id: r, children: C() })
  ] });
...
var To = () => {
  const { replaceMessages: A } = PA(), { replacePaths: e, goToPath: o } = QA(), { replaceToasts: t } = EA(), { hasFlowStarted: n } = eA(), { flowRef: s, timeoutIdRef: a } = $(), { settings: r } = O(), c = (0, import_react.useCallback)(async () => {
    RA(r), a.current && clearTimeout(a.current), A([]), t([]), e([]), await o("start");
  }, [a, r, A, t, e, RA, o]), i = (0, import_react.useCallback)(() => (s == null ? void 0 : s.current) ?? {}, [s]);
  return {
    hasFlowStarted: n,
    restartFlow: c,
    getFlow: i
