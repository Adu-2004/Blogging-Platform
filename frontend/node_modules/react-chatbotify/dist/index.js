...
const Z = {
  ...
  header: {
    title: /* @__PURE__ */ l("div", { style: { cursor: "pointer", margin: 0, fontSize: 20, fontWeight: "bold" }, onClick: () => window.open("https://github.com/tjtanjin/", "_blank", "noopener,noreferrer"), children: "Tan Jin" }),
    showAvatar: !0,
    avatar: Ae,
  ...
  ), [S, C] = j(!1), [h, P] = j(!1), [E, y, b] = sA(!1), [I, m, p] = sA(!0), [
    D,
    Q,
    T
...
const nt = {
  ...
  const { settings: A } = O(), {
    ...
    h !== u.current && c((P) => !P);
  }, [u]), S = x((h, P, E, y) => (h /= y / 2, h < 1 ? E / 2 * h * h + P : (h--, -E / 2 * (h * (h - 2) - 1) + P)), []), C = x((h = 0) => {
    if (!w.current)
      return;
    ...
    const m = () => {
      ...
      I += b;
      const p = S(I, E, y, h);
      w.current.scrollTop = p, I < h ? requestAnimationFrame(m) : i(!1);
    };
    m();
  }, [w]);
  return {
  ...
  return /* @__PURE__ */ X("div", { className: `rcb-checkbox-container ${(p = t.botBubble) != null && p.showAvatar ? "rcb-checkbox-offset" : ""}`, children: [
    A.items.map((D) => /* @__PURE__ */ l(
      "div",
      {
        onMouseDown: (Q) => {
        ...
        children: /* @__PURE__ */ X("div", { className: "rcb-checkbox-row", children: [
          ...
          /* @__PURE__ */ l("div", { className: "rcb-checkbox-label", children: D })
        ] })
      },
      D
    )),
    /* @__PURE__ */ l(
      "div",
      {
        ...
        onMouseDown: (D) => {
          ...
          u(!A.reusable);
          let T;
          A.sendOutput != null ? T = A.sendOutput : T = ((M = t.chatInput) == null ? void 0 : M.sendCheckboxOutput) ?? !0, a(Q, T);
        }
      }
    )
  ] });
  ...
  return /* @__PURE__ */ l("div", { className: `rcb-options-container ${(h = o.botBubble) != null && h.showAvatar ? "rcb-options-offset" : ""}`, children: A.items.map((P, E) => {
    const y = a[E] && !c;
    return /* @__PURE__ */ l(
      "div",
      {
        ...
        onMouseDown: (b) => {
          ...
          i(!A.reusable);
          let I;
          A.sendOutput != null ? I = A.sendOutput : I = ((m = o.chatInput) == null ? void 0 : m.sendOptionOutput) ?? !0, s(P, I);
        },
        children: P
      },
      P
...
const HA = async (A) => {
  ...
  const { settings: A } = O(), { messages: e, setSyncedMessages: o, syncedMessagesRef: t } = jA(), {
    ...
    syncedIsChatWindowOpenRef: r
  } = eA(), { streamMessageMap: c, chatBodyRef: i, paramsInputRef: u } = $(), { scrollToBottom: f, getIsChatBotVisible: w } = rA(), { dispatchRcbEvent: d } = lA(), { speakAudio: g } = YA(), { playNotificationSound: B } = GA(), v = x((m, p = !1) => {
    var M, k;
    HA(m);
    let D = !0;
    ...
    T === "USER" && (D = !1), (M = A.general) != null && M.embedded && w() && (D = !1), (r.current && !a.current || p) && (D = !1), D && B(), !p && (T !== "USER" && ((k = A.chatWindow) != null && k.autoJumpToBottom) || T === "USER" || !a.current) && setTimeout(() => f(), 1);
  }, [
    A,
    i,
    r,
    ...
    if (p = p.toUpperCase(), !c.current.has(p)) {
      const M = gA(m, p);
      return (Q = A.event) != null && Q.rcbStartStreamMessage && (await d(H.START_STREAM_MESSAGE, { message: M })).defaultPrevented ? null : (n(!1), o((k) => [...k, M]), v(t.current), c.current.set(p, M.id), (a.current || !r.current) && s((k) => k + 1), M);
    }
    ...
    return (Q = A.event) != null && Q.rcbStopStreamMessage && (await d(H.STOP_STREAM_MESSAGE, { message: D })).defaultPrevented ? !1 : (c.current.delete(m), HA(t.current), m === "USER" && typeof (D == null ? void 0 : D.content) == "string" && (u.current = D.content), !0);
  }, [d, (I = A.event) == null ? void 0 : I.rcbStopStreamMessage, c, u]), y = x((m) => {
...
const XA = () => {
  ...
  const { settings: A } = O(), { paths: e, setSyncedPaths: o, syncedPathsRef: t } = mA(), { flowRef: n, streamMessageMap: s, paramsInputRef: a, keepVoiceOnRef: r, timeoutIdRef: c } = $(), {
    ...
    streamMessage: h
  } = PA(), { showToast: P, dismissToast: E } = EA(), { toggleChatWindow: y } = rA(), { updateTextAreaFocus: b, setTextAreaValue: I } = DA(), { syncVoice: m } = TA(), p = x(async (R) => {
    var W;
    ...
    return R;
  }, [(U = A.event) == null ? void 0 : U.rcbPostProcessBlock, g]), D = x(async (R, W) => {
    var G, tA, _, nA;
    if (!R)
      return;
    let F = n.current[R];
    ...
    await yt(
      ...
      f,
      p
    ), i(!1), "chatDisabled" in F || u((nA = A.chatInput) == null ? void 0 : nA.disabled), "isSensitive" in F || f(!1), d(typeof F.file == "function"), b(R), m(r.current && !F.chatDisabled), R !== W && s.current.clear();
  }, [
    n,
    b,
    m,
    ...
    r,
    s
  ]), Q = x(() => t.current.length > 0 ? t.current.at(-1) ?? null : null, []), T = x(() => t.current.length > 1 ? t.current.at(-2) ?? null : null, []), M = x(async (R) => {
    var L;
    const W = Q(), F = T();
    return (L = A.event) != null && L.rcbChangePath && (await g(H.CHANGE_PATH, {
      ...
      prevPath: F,
      nextPath: R
    })).defaultPrevented ? !1 : (o((G) => [...G, R]), await D(R, W), !0);
  }, [(J = A.chatInput) == null ? void 0 : J.blockSpam, (z = A.event) == null ? void 0 : z.rcbChangePath, D, g]), k = x((R) => {
  ...
  const { settings: A } = O(), {
  ...
  } = eA(), { flowRef: C, inputRef: h, keepVoiceOnRef: P, paramsInputRef: E, timeoutIdRef: y } = $(), { showToast: b, dismissToast: I } = EA(), { dispatchRcbEvent: m } = lA(), { syncVoice: p } = TA(), { setTextAreaValue: D } = DA(), { toggleChatWindow: Q } = rA(), T = x(async (z) => {
    var F, L, G, tA, _, nA;
    const R = r();
    if (!(!R || !C.current[R])) {
      if (S.current) {
    ...
    let F = C.current[W];
    const L = await u(F);
    L && ((G = A.chatInput) != null && G.blockSpam && w(!0), P.current = v.current, p(!1), setTimeout(() => {
      d(!0);
      ...
      await ge(L, _), a.current.length === nA && ("chatDisabled" in F ? w(!!F.chatDisabled) : w(!!((aA = A.chatInput) != null && aA.disabled)), we(F, _, f), g(typeof F.file == "function"), p(P.current), d(!1));
  ...
  const { settings: A } = O(), { styles: e } = Y(), { unreadCount: o } = eA(), { isChatWindowOpen: t, toggleChatWindow: n } = rA(), [s, a] = j(!1), r = {
    ...
    ) : P && /* @__PURE__ */ l("span", { className: "rcb-toggle-icon", children: /* @__PURE__ */ l(P, { style: i }) });
  };
  ...
  V(() => {
    ...
    if (P === "ALWAYS")
      if (A) {
        let I;
        n ? I = (((y = t.current) == null ? void 0 : y.offsetWidth) ?? 375) - (typeof ((b = o.chatButtonStyle) == null ? void 0 : b.width) == "number" ? o.chatButtonStyle.width : 75) : I = 0, f(I), r(!0);
      } else
        r(!n);
  ...
  return /* @__PURE__ */ l(oA, { children: !((C = e.general) != null && C.embedded) && /* @__PURE__ */ X(
    "div",
    {
      ...
      onClick: () => s(!0),
      children: [
        /* @__PURE__ */ l("span", { children: (h = e.tooltip) == null ? void 0 : h.text }),
  ...
  V(() => {
    const y = (m) => {
      ...
      a.current && !p.includes(a.current) && r.current && !p.includes(r.current) && i(!1);
    }, b = () => {
  ...
  return /* @__PURE__ */ X(oA, { children: [
    ...
    c && /* @__PURE__ */ l("div", { className: "rcb-emoji-button-popup", ref: a, children: (E = (P = A.emoji) == null ? void 0 : P.list) == null ? void 0 : E.map((y, b) => /* @__PURE__ */ l(
      "span",
      {
        className: "rcb-emoji",
        onMouseDown: (I) => d(I, y),
  ...
  const d = {
    ...
    !b.fileType || !b.fileUrl || await o(/* @__PURE__ */ l(
      ye,
      {
        file: y,
        fileType: b.fileType,
  ...
  } = eA(), { chatBodyRef: d } = $(), { viewportHeight: g, setViewportHeight: B, setViewportWidth: v, scrollToBottom: S } = rA(), { setUpNotifications: C } = GA(), { handleFirstInteraction: h } = me(), { showChatHistory: P } = KA(), E = AA(0), y = AA(!1);
  V(() => (window.addEventListener("click", h), window.addEventListener("keydown", h), window.addEventListener("touchstart", h), () => {
    ...
    const Q = () => {
      y.current || (y.current = !0, requestAnimationFrame(() => {
        ...
        u(U), f.current = U, U || (T + M >= k - 1 && (D.scrollTop = k - M - 1), (w.current || (K = e.general) != null && K.embedded) && s(0)), y.current = !1;
      }));
    };
    return D.addEventListener("wheel", Q, { passive: !0 }), D.addEventListener("touchmove", Q, { passive: !0 }), () => {
  ...
  }, [(b = e.notification) == null ? void 0 : b.disabled]), V(() => {
  ...
  }, [(I = e.chatHistory) == null ? void 0 : I.storageKey, (m = e.chatHistory) == null ? void 0 : m.maxEntries, (p = e.chatHistory) == null ? void 0 : p.disabled]), V(() => {
    var D;
    A || (D = e.general) != null && D.embedded || !navigator.virtualKeyboard || (navigator.virtualKeyboard.overlaysContent = !0, navigator.virtualKeyboard.addEventListener("geometrychange", (Q) => {
      if (!Q.target)
        return;
...
`), Do = () => kA(re), Eo = () => kA(ce), yo = async (A, e, o, t) => {
  ...
  return /* @__PURE__ */ l(oA, { children: (() => {
    ...
    "div",
    {
      onMouseDown: (P) => {
        var E, y;
        !s && ((E = t.general) == null ? void 0 : E.flowStartTrigger) === "ON_CHATBOT_INTERACT" && a(!0), o ? (y = r.current) == null || y.blur() : P == null || P.preventDefault();
      },
      className: B,
      children: [
        /* @__PURE__ */ l(Xt, {}),
        ...
        /* @__PURE__ */ l("div", { style: v(), className: "rcb-chat-window", children: (() => {
          ...
          return /* @__PURE__ */ X(oA, { children: [
            ((I = t.general) == null ? void 0 : I.showHeader) && /* @__PURE__ */ l(P, { buttons: w }),
            /* @__PURE__ */ l(E, {}),
            /* @__PURE__ */ l(Kt, {}),
            ((m = t.general) == null ? void 0 : m.showInputRow) && /* @__PURE__ */ l(y, { buttons: d }),
            ((p = t.general) == null ? void 0 : p.showFooter) && /* @__PURE__ */ l(b, { buttons: g })
          ] });
        })() })
      ]
    }
