    ...
    <div className='relative'>
     ...
     <Navbar/>
      <div className='text-center mt-20 text-gray-600'>
         ...
         <p className='inline-block py-1 px-4 rounded-full mb-6 border border-primary/40 bg-blue-100 font-medium text-sm text-blue-700'>Michael Brown</p>
     </div>
          ...
          <div className='mt-14 mb-10 max-w-3xl mx-auto'>
             ...
             <div className='flex flex-col gap-4'>
              {Comments.map((item, index) =>(
                <div key={index} className='relative bg-blue-50 border border-blue-300 max-w-xl p-4 rounded text-gray-600'>
