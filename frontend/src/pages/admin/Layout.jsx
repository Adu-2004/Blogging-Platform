...
const Layout = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-between py-2 h-[70px] px-4 sm:px-12 border-b border-gray-200'>
      ...
      <button onClick={logout} className='text-sm px-8 py-2 bg-blue-500 text-white rounded-full cursor-pointer'>Logout</button>
    </div>
      ...
      <div className='flex items-center justify-between py-2 h-[70px] px-4 sm:px-12 border-b border-gray-200'>
        ...
        />
         <div className="flex items-center gap-4">
          ...
          {userName && (
            <span className="text-gray-700 font-semibold whitespace-nowrap mr-2">
              Welcome, {userName}
            </span>
          )}
          </div>
